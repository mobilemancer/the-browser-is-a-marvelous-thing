...
[x] on the cascade layers slide, make the button change color when slapping on the utility layer
...
[x] add animation to the FAQ expansion and contraction for the Details & summary slide
[ ] talking points for how the progress percentage get updated in the Progress slide
[x] make .code-panel and .result-panel have the same height in all the slides
[ ] fix styling so .results-panel isn't as high for the user profile card in the View transitions API slide
